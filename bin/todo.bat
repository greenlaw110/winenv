...
REM GREEN BATCH FILE: launch todos.txt
REM VERSION 0.0.2.1
REM Last updated by greenlaw110@gmail.com at Nov-20-2007
REM created by greenlaw110@gmail.com at Nov-20-2007
...
%__EXEC% %LGL_EDITOR% %_DOC%\todos.txt
