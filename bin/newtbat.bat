...
REM GREEN BATCH UTILITY[ newtbat.bat ] create an new temp batch 
...
%__EXEC% copy %BATCH_TEMPLATE% %_TBIN%\%1.bat
%__EXEC% %LGL_EDITOR% %_TBIN%\%1.bat
...
:_HELP
echo create new bat in temp bin folder
echo usage: 
echo       %~nx0 ^<bat_name^>
goto _END
